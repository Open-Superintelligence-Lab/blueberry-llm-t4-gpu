#!/usr/bin/env python3
"""
Simple Training Speed Experiments Runner

This script runs the training speed experiments with record tracking,
automatically detecting the current working directory.
"""
...
def main():
    ...
    if not os.path.exists("experiments.py"):
        print("❌ experiments.py not found in current directory")
